...
- Copy fpga bitstream i.e ```baseline_a55_hps_debug.core.rbf``` at ```meta-custom/recipes-fpga/fpga-bitstream/files/```
...
FPGA options
 ...
 (baseline_a55_hps_debug.core.rbf) Core RBF configuration bitstream filename
```
...
- During the build, the baseline_a55_hps_debug.core.rbf file is installed to:
