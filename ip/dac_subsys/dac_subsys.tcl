...
#
# Stage 3 (PLAN.md): control plane only. All JESD-side interfaces of
# u_dac_controller_0 are stubbed by u_jesd_stub (a Phase B placeholder
# component, ip/jesd_stub/ -- relocated from ip/dac_subsys/jesd_stub/ in
# Stage 4 so it sits at the same nesting depth as dac_controller_0_hw.tcl;
# Quartus's IP catalog scan finds same-depth custom IPs reliably during
# sub-qsys-generate invocations). Stage 6 deletes u_jesd_stub and
# replaces it with the Intel JESD204B GTS Subsystem IP.
#
...
#   0x2000  reserved for JESD GTS Subsystem    8 KB   (Stage 6 placeholder)
#
...
#   jesd_tx_link_clk   clock sink       (~250 MHz, Stage 4 ties to system_clock
#                                        until Stage 6 brings up GTS link layer)
...
set_instance_parameter_value u_clk_bridge_jesd EXPLICIT_CLOCK_RATE 250000000
...
# =============================================================================
# u_jesd_stub  -- JESD STUB - REMOVE IN STAGE 6 --
# Terminates the JESD-side interfaces of u_dac_controller_0 so the system
# generates standalone without the GTS Subsystem IP.
# =============================================================================
...
add_connection u_dac_controller_0.jesd_link0_data   u_jesd_stub.jesd_link0_data
add_connection u_dac_controller_0.jesd_link1_data   u_jesd_stub.jesd_link1_data
